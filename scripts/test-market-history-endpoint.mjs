...
const secret=process.env.CRON_SECRET??process.env.MARKET_CRON_SECRET;
if(!secret)throw new Error("CRON_SECRET or MARKET_CRON_SECRET is missing from .env.local");
